    ...
    <div class="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
        ...
        <form action="{{ route('staff.store') }}" method="POST" class="space-y-6">
            ...
            <div class="flex flex-col sm:flex-row justify-end gap-3 pt-4 border-t border-slate-100">
                <a href="{{ route('staff.index') }}" class="flex items-center justify-center px-6 py-3 min-h-[44px] text-sm font-bold text-slate-700 bg-slate-100 hover:bg-slate-200 rounded-xl transition w-full sm:w-auto">
                    Batal
                </a>
