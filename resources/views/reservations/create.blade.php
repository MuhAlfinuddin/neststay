            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input id="check_in" name="check_in" type="date" required min="{{ date('Y-m-d') }}" value="{{ old('check_in') }}" class="mt-1 appearance-none block w-full px-4 py-3 border border-slate-300 rounded-xl placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[var(--color-teak)] focus:border-[var(--color-teak)] text-[16px]">
                    </div>

                    <div>
                        <label for="check_out" class="block text-sm font-semibold text-slate-700">Tanggal Check-out</label>
                        <input id="check_out" name="check_out" type="date" required value="{{ old('check_out') }}" class="mt-1 appearance-none block w-full px-4 py-3 border border-slate-300 rounded-xl placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[var(--color-teak)] focus:border-[var(--color-teak)] text-[16px]">
                    </div>
                </div>
