        ...
        <form action="{{ route('rooms.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                    ...
                    <input id="price_per_night" name="price_per_night" type="number" min="0" placeholder="Contoh: 250000" required value="{{ old('price_per_night') }}" inputmode="numeric" autocomplete="off" class="mt-1 appearance-none block w-full px-4 py-3 border border-slate-300 rounded-xl placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[var(--color-teak)] focus:border-[var(--color-teak)] text-[16px]">
                </div>
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="3" placeholder="Tambahkan deskripsi fasilitas kamar, e.g. AC, TV, King Bed..." class="mt-1 appearance-none block w-full px-4 py-3 border border-slate-300 rounded-xl placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[var(--color-teak)] focus:border-[var(--color-teak)] text-[16px]">{{ old('description') }}</textarea>
            </div>
